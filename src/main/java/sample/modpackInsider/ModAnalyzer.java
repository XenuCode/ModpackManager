...
public class ModAnalyzer {
    ...
    public static void analyzeMod(String modpath){
        ...
        Toml tomlj = new Toml().read(new File(System.getenv("APPDATA")+"/"+"ModpackManager"+"/"+"temp"+"/"+"META-INF"+"/"+"mods.toml"));
        ...
        new File(System.getenv("APPDATA")+"/"+"ModpackManager"+"/"+"temp"+"/"+"META-INF"+"/"+"mods.toml").delete();
        System.out.println(modData.getModName());
    }

    private static void extractSingleModData(String modpath){
        File file = new File(System.getenv("APPDATA")+"/"+"ModpackManager"+"/"+"temp");
        if(file.isDirectory())
        {
            try {
                new ZipFile(modpath).extractFile("META-INF/mods.toml",System.getenv("APPDATA")+"/"+"ModpackManager"+"/"+"temp");
